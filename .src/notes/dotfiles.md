...
**Revision No. 743, commit `363ff48`.**

**"sxhkd: Rewrote some commands, colorized syslog, nmtui"**
...
<pre><code><span class="term-prompt">root@2c93e53ab55b</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
