...
**Revision No. 779, commit `e81b7e9`.**
...
<pre><code><span class="term-prompt">root@dc6ad623f232</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
...
<!-- updated Wed, 19 Jan 2022 17:24:49 -0800 -->
