...
**Revision No. 781, commit `3c3b05a`.**
...
<pre><code><span class="term-prompt">root@eb3da22ce739</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
