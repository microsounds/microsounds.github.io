...
**Revision No. 714, commit `af8b3d5`.**
...
<pre><code><span class="term-prompt">root@6ded95521fbb</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
