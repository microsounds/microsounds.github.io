...
**Revision No. 774, commit `e72a8e9`.**

**"nano-overlay: Reworked help and version screens"**
...
*57.3KiB* then this document
currently covers about <b style="font-size: 130%;">7.28%</b>
...
<pre><code><span class="term-prompt">root@90a0666cd6f3</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
...
-rwxr-xr-x 1  23K   Jan  8 2022 20:02 rev. 86  <a href="https://raw.githubusercontent.com/microsounds/atelier/master/Scripts/nano_overlay.sh">Scripts/nano_overlay.sh</a>
...
<!-- updated Sat, 8 Jan 2022 20:02:53 -0800 -->
