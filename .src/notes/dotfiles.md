...
**Revision No. 825, commit `11b0724`.**
...
<pre><code><span class="term-prompt">root@4c15abc0489c</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
