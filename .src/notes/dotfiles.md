...
**Revision No. 774, commit `faad3aa`.**
...
<pre><code><span class="term-prompt">root@d49c0d659758</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
