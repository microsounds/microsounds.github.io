...
**Revision No. 781, commit `d454740`.**

**"GTK2/3: Generating commonly used bookmarks at startup"**
...
*57.7KiB* then this document
currently covers about <b style="font-size: 130%;">7.24%</b>
...
<pre><code><span class="term-prompt">root@3b9f7575e914</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
...
-rw-r--r-- 1 1.9K   Jan 27 2022 14:09 rev. 65  <a href="https://raw.githubusercontent.com/microsounds/atelier/master/.xinitrc">.xinitrc</a>
...
<!-- updated Thu, 27 Jan 2022 14:09:40 -0800 -->
