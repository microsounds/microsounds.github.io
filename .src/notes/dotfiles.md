...
**Revision No. 725, commit `7120f09`.**
...
<pre><code><span class="term-prompt">root@98ae8728b176</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
