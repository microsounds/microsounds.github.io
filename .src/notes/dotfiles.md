...
**Revision No. 834, commit `a25bc01`.**

**"magnet-dl: Fixed IPv6 issues, allow for bundling multiple magnet URIs"**
...
<pre><code><span class="term-prompt">root@f799b7716047</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
...
-rw-r--r-- 1 2.4K   Jul 12 2022 00:21 rev. 5   <a href="https://raw.githubusercontent.com/microsounds/atelier/master/.github/workflows/magnet-dl.yml">.github/workflows/magnet-dl.yml</a>
...
<!-- updated Tue, 12 Jul 2022 00:21:03 -0700 -->
