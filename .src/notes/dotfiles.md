...
**Revision No. 701, commit `913e957`.**
...
<pre><code><span class="term-prompt">root@0562c28b1472</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
