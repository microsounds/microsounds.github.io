...
**Revision No. <b style="font-size: 130%">866</b>, commit `1c9564d`.**

**"bash: Disable path-gitstatus after detecting 500ms of latency"**
...
-rw-r--r-- 1 3.4K   Jan 20 2023 11:59 rev. 27  <a href="https://raw.githubusercontent.com/{AUTHOR}/atelier/master/.github/workflows/ci.yml">.github/workflows/ci.yml</a>
...
-rwxr-xr-x 1 2.2K   Jan 20 2023 22:38 rev. 30  <a href="https://raw.githubusercontent.com/{AUTHOR}/atelier/master/Scripts/xwin_decor.sh">Scripts/xwin_decor.sh</a>
...
<!-- updated Fri, 3 Feb 2023 18:05:10 -0800 -->
