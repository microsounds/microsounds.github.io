...
**Revision No. 789, commit `647b5da`.**

**"chromium: Commemorating 5th attempt at adopting vimium"**
...
<pre><code><span class="term-prompt">root@1c0a722f5880</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
...
-rw-r--r-- 1 1.6K   Feb 12 2022 00:46 rev. 1   <a href="https://raw.githubusercontent.com/microsounds/atelier/master/.config/chromium/vimium-options.json">.config/chromium/vimium-options.json</a>
...
<!-- updated Sat, 12 Feb 2022 00:46:41 -0800 -->
