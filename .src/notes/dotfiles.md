...
**Revision No. 777, commit `248a5eb`.**

**"chromium: Updated chrome flags for chromium 97"**
...
<pre><code><span class="term-prompt">root@fa35d5ef535e</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
...
<!-- updated Mon, 17 Jan 2022 18:01:04 -0800 -->
