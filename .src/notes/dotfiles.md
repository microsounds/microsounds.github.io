...
**Revision No. 794, commit `44c49e8`.**

**"gh-actions: Improved usability of magnet download workflow"**
...
<pre><code><span class="term-prompt">root@7f3a0e76dbec</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
...
-rw-r--r-- 1 1.9K   Feb 16 2022 14:48 rev. 2   <a href="https://raw.githubusercontent.com/microsounds/atelier/master/.github/workflows/magnet-dl.yml">.github/workflows/magnet-dl.yml</a>
...
<!-- updated Wed, 16 Feb 2022 14:48:07 -0800 -->
