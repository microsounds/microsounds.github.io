...
**Revision No. 734, commit `8b4262d`.**

**"sc: Force unobtrusive background color"**
...
approximate size of all comment lines of code is *53KiB*,
then this document currently covers about
<b style="font-size: 20px;">6.74%</b> of all implemented features
...
<pre><code><span class="term-prompt">root@b3fa80e677a9</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
...
-rw-r--r-- 1  19K   Dec 13 2021 00:27 rev. 157 <a href="https://raw.githubusercontent.com/microsounds/atelier/master/readme.md">readme.md</a>
</code></pre>
<!-- updated 2021-12-14 -->
