...
**Revision No. 775, commit `5e53e29`.**
...
<pre><code><span class="term-prompt">root@e5a70902ba9d</span>:<span class="term-dir">~</span>$ git meta ls-tree --name-only -r master | xargs ls -lhgG
...
<!-- updated Mon, 10 Jan 2022 12:15:44 -0800 -->
